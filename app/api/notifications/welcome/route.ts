...
const WELCOME_NOTIFICATION_BODY = [
  "Поздравляем с регистрацией! Мы приготовили для тебя мини-инструкцию для быстрого погружения в RIVN OS.",
  "",
  "Вариант 1: Открой раздел [Инструкция](https://rivnos.ru/guide) и посмотри видео с обзором платформы.",
  "",
  "Вариант 2: Если хочешь разобраться самостоятельно, то вот тебе быстрый гайд.",
  "",
  "1) Заполни настройки кабинета. Постарайся заполнить максимум параметров и данных.",
  "2) Если есть сотрудники - пригласи их.",
  "3) Добавь своих клиентов.",
  "4) Под клиентов создай проекты.",
  "5) Поставь первые задачи.",
  "6) Зафиксируй прошлые и плановые оплаты/расходы.",
  "",
