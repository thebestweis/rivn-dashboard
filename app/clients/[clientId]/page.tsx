...
const [isSavingNotes, setIsSavingNotes] = useState(false);
        ...
        <main className="flex-1">
          <div className="space-y-6 px-5 py-6 lg:px-8">
            ...
            <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-6">
              {[
                ...
                { label: "Налог", value: currentClient.tax },
                {
                  ...
                  tone: clientProfitNumber >= 0 ? "text-emerald-300" : "text-rose-300",
                },
              ].map((item) => (
                <div
                  key={item.label}
            ...
            <section className="grid gap-6 xl:grid-cols-[1.35fr_0.95fr]">
              ...
              <div className="space-y-6">
                <div className="rounded-[28px] border border-white/10 bg-[#121826] p-5 shadow-[0_10px_40px_rgba(0,0,0,0.32)]">
                  <div className="text-sm text-white/50">Структура экономики клиента</div>
                  ...
                  <div className="mt-4 space-y-3">
                    <div className="flex items-center justify-between rounded-2xl bg-white/[0.04] px-4 py-3">
                      ...
                      <span className="font-medium">{currentClient.directExpenses}</span>
                    </div>
  ...
  <textarea
    ...
    rows={8}
    className="mt-4 w-full rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-4 text-sm leading-6 text-white outline-none placeholder:text-white/30"
  />
</div>
              </div>
            </section>
