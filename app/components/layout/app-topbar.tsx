...
export function AppTopbar({
  ...
  return (
    <header className="sticky top-[65px] z-20 border-b border-slate-200 bg-white/85 backdrop-blur-xl lg:top-0 dark:border-white/10 dark:bg-[#0B0F1A]/85">
  <div className="relative overflow-hidden border-b border-slate-200 bg-white px-4 py-4 dark:border-white/5 dark:bg-[radial-gradient(circle_at_top,rgba(111,90,255,0.16),transparent_34%),radial-gradient(circle_at_82%_16%,rgba(16,185,129,0.12),transparent_18%),linear-gradient(180deg,rgba(11,15,26,0.98),rgba(9,13,24,0.96))] sm:px-5 lg:px-8 lg:py-6">
        ...
        <div className="relative flex min-w-0 flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
          <div className="min-w-0">
            ...
            <h1 className={`${eyebrow ? "mt-2" : ""} text-2xl font-bold tracking-[-0.03em] text-slate-950 sm:text-[30px] dark:text-white`}>
  {title}
</h1>
