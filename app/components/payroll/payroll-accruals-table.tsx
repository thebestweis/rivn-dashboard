        ...
        <table className="w-full min-w-[920px] text-center text-sm">
          <thead className="bg-white/[0.04] text-white/45">
            <tr>
              ...
              <th className="px-4 py-3 font-medium"><StableSortHeader sort="client" sortKey={sortKey} sortDirection={sortDirection} onSort={handleSort}>Клиент</StableSortHeader></th>
              <th className="px-4 py-3 font-medium"><StableSortHeader sort="project" sortKey={sortKey} sortDirection={sortDirection} onSort={handleSort}>Проект</StableSortHeader></th>
              <th className="px-4 py-3 font-medium"><StableSortHeader sort="date" sortKey={sortKey} sortDirection={sortDirection} onSort={handleSort}>Дата</StableSortHeader></th>
