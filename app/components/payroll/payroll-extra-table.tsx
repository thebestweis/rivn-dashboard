        ...
        <table className="w-full min-w-[720px] text-center text-sm">
          <thead className="bg-white/[0.04] text-white/45">
            <tr>
              ...
              <th className="px-4 py-3 font-medium"><StableSortHeader sort="reason" sortKey={sortKey} sortDirection={sortDirection} onSort={handleSort}>Причина</StableSortHeader></th>
