        ...
        <div className="min-h-screen px-6 py-10">
          <div className="mx-auto flex min-h-[80vh] max-w-3xl items-center justify-center">
            <div className="w-full rounded-[32px] border border-white/10 bg-[#121826] p-8 shadow-[0_20px_80px_rgba(0,0,0,0.45)] md:p-12">
              ...
              <div className="text-sm text-white/45">Критическая ошибка</div>
              ...
              <p className="mt-4 max-w-2xl text-base leading-7 text-white/65">
                Попробуй обновить страницу. Если ошибка повторяется, напиши нам
                в Telegram — мы поможем решить проблему.
              </p>
